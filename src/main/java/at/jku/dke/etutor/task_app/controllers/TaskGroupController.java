 ...
 *
 * @param <S> The type of the task group DTO.
...
public interface TaskGroupController<S, T> {
    /**
    ...
    ResponseEntity<S> get(@Parameter(description = "The task group identifier.") @PathVariable long id);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<S> create(@Parameter(description = "The task group identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskGroupDto<T> dto);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<Void> update(@Parameter(description = "The task group identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskGroupDto<T> dto);
