...
public interface TaskGroupController<D, T> {
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = AuthConstants.API_KEY_REQUIREMENT))
    ResponseEntity<Serializable> create(@Parameter(description = "The task group identifier.") @PathVariable long id, @RequestBody ModifyTaskGroupDto<T> dto);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = AuthConstants.API_KEY_REQUIREMENT))
    ResponseEntity<Serializable> update(@Parameter(description = "The task group identifier.") @PathVariable long id, @RequestBody ModifyTaskGroupDto<T> dto);
