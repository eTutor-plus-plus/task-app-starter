...
public interface TaskController<D, T> {
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = AuthConstants.API_KEY_REQUIREMENT))
    ResponseEntity<TaskModificationResponseDto> create(@Parameter(description = "The task identifier.") @PathVariable long id, @RequestBody ModifyTaskDto<T> dto);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = AuthConstants.API_KEY_REQUIREMENT))
    ResponseEntity<TaskModificationResponseDto> update(@Parameter(description = "The task identifier.") @PathVariable long id, @RequestBody ModifyTaskDto<T> dto);
