...
public interface TaskController<S, T> {
    ...
    ResponseEntity<S> get(@Parameter(description = "The task identifier.") @PathVariable long id);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<S> create(@Parameter(description = "The task identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskDto<T> dto);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<Void> update(@Parameter(description = "The task identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskDto<T> dto);
