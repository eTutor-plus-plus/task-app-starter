...
public interface TaskController<D, T> {
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<Serializable> create(@Parameter(description = "The task identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskDto<T> dto);
    ...
    @Operation(
        ...
        security = @SecurityRequirement(name = "api-key"))
    ResponseEntity<Serializable> update(@Parameter(description = "The task identifier.") @PathVariable long id, @Valid @RequestBody ModifyTaskDto<T> dto);
